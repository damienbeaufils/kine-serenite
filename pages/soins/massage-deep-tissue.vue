      ...
      <v-row justify="center">
        ...
        <v-col cols="12">
          ...
          <p>
            ...
            plutôt :
            <b
              >« On fait la connaissance de tout le monde et on leur dit bonjour
          ...
          <p>
            <b
              >Évidemment, chaque personne a un seuil de tolérance différent et
        ...
        <v-col cols="12" class="mt-4">
          ...
          <ul>
            <li>
              ...
              ouverte…
              <b
                >Et si vous avez un doute, veuillez consulter votre médecin !</b
              >
            </li>
            <li>
              <b
                >Si vous prenez une douche avant, vaut mieux éviter de vous
                crémer</b
              >
              ...
              <b
                >je peux toujours ajouter un peu d’huile neutre si vous craignez
                le “sans-huile”</b
              >.
            </li>
            <li>
              <b
                >Enfin, si vous souhaitez essayer ce soin mais vous n’êtes pas
                certain·e</b
              >
...
export default {
  head() {
    return {
      title:
        'Massage des tissus profonds (Deep Tissue) |  Virginie Dang | Masso-kinésithérapeute & Orthothérapeute',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content:
            'Qu’est-ce que le massage des tissus profonds (Deep Tissue) ? Pour qui ? Les bienfaits et ce qu’il faut aussi savoir. Prise de rendez-vous pour un massage des tissus profonds (Deep Tissue).',
        },
      ],
      link: [
        {
          rel: 'canonical',
          href: 'https://kine-serenite.ca/soins/massage-deep-tissue/',
        },
      ],
    }
  },
